...
const { create, read, billetDelete, billetCheck, edit, commentCreate, commentDelete, getAll } = require("./blogController");
const { blogCreateValidator, blogDeleteValidator } = require("./blogValidator");
